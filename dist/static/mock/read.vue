    ...
    <div class="footer">
      <mu-bottom-sheet :open="bottomSheet" @close="closeBottomSheet">
        ...
        <div :style="showPro">
          ...
          <div><span class="frontChar allChangeChar" @click="changeCharpter(charpterNumber-1)">上一章</span> <span class="nextChar allChangeChar" @click="changeCharpter(charpterNumber+1)">下一章</span></div>
        </div>
